```json
{
	...
	"date": "2011-06-26",
	"tags": "coding, programming, standards, guidelines, community, open-source, licensing"
}
```
...
I hope this post will help you guys with your open-source projects as the advice within has with mine.
