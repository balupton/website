...
<title>Templates: Level 2 - Shortcuts</title>
<style type="text/css">
			...
			<div class="search_content">
				...
				for ( $i = 0, $n = sizeof($list); $i < $n; ++$i )
				{
					...
					<div class="search_result">
						...
						Welcome to Search Result <?php echo $data['number']; ?>
						</div>
						<div class="search_result_content">
						Search Result <?php echo $data['number']; ?> Contents
						</div>
						<div class="search_result_outro">
						Goodbye from Search Result <?php echo $data['number']; ?>
						</div>
					</div>
					<?php
				}
