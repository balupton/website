...
# Subscribe Buttons
aside '.page-subscribe.subscribeButtons', ->
	# Like
	div '.subscribeButton.like', ->
		text """
			<iframe src="//www.facebook.com/plugins/like.php?href=#{@document.url}&amp;send=false&amp;layout=button_count&amp;width=450&amp;show_faces=false&amp;font&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=266367676718271" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:450px; height:21px;" allowTransparency="true"></iframe>
			"""
